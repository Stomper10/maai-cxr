...
if __name__ == '__main__':
    ...
    weights = glob.glob('/home/gyuseonglee/workspace/maai-cxr/src/kslee001/quantization/weights/ensemble/*.h5')
    for weight in tq(weights) : 

        SAVE_NAME = './quantized_weights/ensemble/' + weight.rsplit('/', 1)[1].rsplit('.h5', 1)[0]
        # load model
