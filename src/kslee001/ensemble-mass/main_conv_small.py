...
if __name__ == '__main__':
    ...
    configs.wandb.run_name = f'final-{configs.general.seed}-{configs.model.backbone}small-{configs.dataset.image_size[0]}'
    ...
    configs.saved_model_path = "./" + f"{configs.model.backbone}small_{configs.general.seed}_" + "{epoch:02d}-{val_loss:.2f}.h5" 
